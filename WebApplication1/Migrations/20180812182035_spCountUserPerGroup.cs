...
{
    public partial class spCountUserPerGroup : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_rejoint", x => new { x.idGroup, x.idUser });
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeactiveDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    EmailAdress = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Gender = table.Column<string>(type: "char(10)", nullable: false),
                    GravatarUrl = table.Column<string>(type: "nchar(10)", nullable: true),
                    idGroup = table.Column<int>(type: "int", nullable: false),
                    isInactive = table.Column<bool>(type: "bit", nullable: false),
